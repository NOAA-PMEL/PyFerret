 ...
 * various fortran calls.
 *
 */
 
#ifndef _FERRET_FORTRAN_H 
#define _FERRET_FORTRAN_H
...
#define 		FACTN_FERRET_SET_DATA	 6  /* added by oz 10/31/94 */
#define 		FACTN_SYNCH_SET_DATA	 6
