...
/*
use WindowMapping(0) for invisible windows; WindowMapping(0) for mapped ones.
*/
    ...
    WS_STATE_PTR    wk;
{
	...
	if ((wk->dpy = GetCurrDisplay()) == NULL) { 
	    status = 26;
	} else {
	    char           *ptr = DisplayString(wk->dpy);					/* Open a new display */
