...
def ferret_init(efid):
    ...
    retdict = { "numargs": 6,
                ...
                "argdescripts": ( "Shapefile name (any extension given is ignored)",
                                  "X values (longitudes) for the quad. grid; must be 2D on X and Y",
                                  "Y values (latitudes) for the quad. grid; must be 2D on X and Y",
                                  "Shape values; must be 2D on X and Y",
